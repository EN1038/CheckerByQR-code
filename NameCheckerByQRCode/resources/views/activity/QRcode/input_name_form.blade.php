...
<div class="contrainer">
    <ul class="circles">
      ...
      <div class="d-flex flex-column justify-content-center align-items-center h-100 w-100 border border-danger">
        <div class="d-flex justify-content-center align-items-center p-5 border border-success w-75 ">
            <div class="glassmorphism-body p-5">
                <p class="fs-1 fw-bold text-center text-success">ฟอร์มกรอกชื่อ</p>
                ...
                <form action="{{route('input_form_checker_post',request()->route()->activity_id)}}" method="post">
                    ...
                    <div class="form-floating my-5">
                        <input type="input" name="name" class="form-control" id="floatingInput" placeholder="กรุณากรอกชื่อจริง">
