...
<link rel="stylesheet" href="{{asset('css/style_bg_danger.css')}}">
        ...
        <div class="d-flex justify-content-center align-items-center w-75 ">
            <div class="glassmorphism-body-circle p-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <i class="fa-solid fa-circle-exclamation fa-beat edit-icon text-danger"></i>
                    <p class="edit-text text-danger fw-bold">หมดเวลาการเช็คชื่อ !</p>
                    <div class="d-flex justify-content-center align-items-center my-2">
                        <i class="fa-solid fa-clock fa-shake text-danger fs-1"></i>
                        <div id="current-time" class="col text-danger ps-4 fs-1">00:00:00</div> 
                    </div>
