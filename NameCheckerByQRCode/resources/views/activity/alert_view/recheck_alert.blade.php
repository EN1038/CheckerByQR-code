...
<link rel="stylesheet" href="{{asset('css/style_bg_warning.css')}}">
        ...
        <div class="d-flex justify-content-center align-items-center w-75 ">
            <div class="glassmorphism-body-circle p-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <i class="fa-solid fa-circle-exclamation fa-beat edit-icon text-warning"></i>
                    <p class="edit-text text-warning fw-bold">เช็คชื่อไปแล้ว !</p>
                    <div class="d-flex justify-content-center align-items-center my-2">
                        <i class="fa-solid fa-clock fa-shake text-warning fs-1"></i>
                        <div id="coutdown-close" class="col text-warning ps-4 fs-1">00:00</div> 
                    </div>
